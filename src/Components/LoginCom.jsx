    ...
    <div>
      ...
      <div className='flex p-52 py-32'>
          ...
          <form action="" className='w-full'>
            ...
            <label className="input input-bordered flex h-16 items-center gap-2 mb-9">
            ...
            <div className='flex items-center'>
              <div className="form-control">
                <label className="cursor-pointer label">
                  ...
                  <span className="label-text pl-5">Remember me</span>
                </label>
              </div>
            ...
            <button className='bg-yellow-400 w-full p-5 rounded-md mt-4 text-white'>Submit</button>
        </form>
      </div>
