...
// /api/v1/admin/app/merchant_management/get/all_merchants
const DashOverviewMerchantCompo = () => {

    const url = `${BASE_URL}api/v1/admin/merchant_management/get/all_merchants`
    ...
    const getTotalMerchants = async () =>{
      try {
        ...
        if(res.ok || res.statusCode === 200){
          ...
          setMerchantAll(users.merchants)
          setIsLoading(false)
        }
                ...
                <div className='lg:w-full '>
                    ...
                    <div className="overflow-x-auto">
                        <table className="table table-xs">
                            ...
                            {merchantAll.map((eachUser, index)=>(

                                <tbody key={index}>
                                <tr>
                                    <Link to={`/merchant-details/${eachUser._id}`}><td className='pt-5 underline'>{eachUser.firstName} {eachUser.lastName}</td> </Link>
